...
<a href="#skip-menu" class="hidden">Cкрыть меню</a>
		...
		<!-- Menu -->
		<ul id="menu">
			<li><a href="index.php" class="active">Саҳифаи Асосӣ</a></li>
		...
		<div id="content-box-in">
			...
			<div id="content-box-in-left">
				...
				<div style="font-weight: bold; font-size: 15px; width: 560px; color: #004A70;">
					<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Мутахассисони бо тачрибаи мо махсулотхои сохтмонии бетони, оханин ва чубинро дар вакти кутох ва бо хохиш ва дархости мизоч тайёр менамоянд. </p>
				</div><br>
