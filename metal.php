		...
		<div id="content-box-in">
			...
			<div id="content-box-in-left">
				<div id="content-box-in-left-in">
					<h3 class="line"><span>Металлоизделия и металлоконструкция</span></h3>
						...
						<div class="galerie">
							...
							<div class="object">
								...
								<div class="about">
									...
									<br>
										<b><i>Продукт: Ворота металлические </i></b><br>
										<b><i>Модель: 1 </i></b><br>
							...
							<div class="object">
								...
								<div class="about">
									...
									<div class="block_info">
									<br>
										<b><i>Металлические навесы и прочие металлоконструкции.
У нас Вы можетe заказать абсолютно любое изделие. Мы работаем по готовым эскизам, а также даем консультации для разработки 
</i></b><br>
										<b><i>Размер, мм:	Любой</i></b><br>
										<b><i>Цена:	Договорная</i></b><br>
									</div>
								</div>
							</div>
							...
							<div class="object">
								...
								<div class="about">
									...
									<div class="block_info">
									<br>
										<b><i>Продук: Ограждение металические</i></b><br>
										<b><i>Размер, мм:	любой</i></b><br>
										<b><i>Цена:	Договорная</i></b><br>
									</div>
								</div>
